# Projeto Estrtura de Dados
 ...
 # Problema
   ...
   Cada algoritmo deverá ordenar os mesmos vetores de entrada, permitindo uma comparação justa de desempenho. O tempo de execução será medido em 10000 execuções para o Data set 1 e 100 execuções para o Data set 2, utilizando-se a média dos resultados obtidos para avaliar a eficiência de cada método de ordenação.
